...
import { Button, Text, View, StyleSheet, ViewStyle, TextStyle, ScrollView, Pressable, Linking, Alert, RefreshControl } from 'react-native';
                ...
                {loaded &&
                    <View style={styles.contentContainer}>
                        ...
                        <View style={styles.openIservButtonContainer}>
                            <Button color={colors.primary} title="In Iserv öffnen" onPress={() => {
                                ...
                                <View style={styles.filesContainer}>
                                    {task.providedFiles.map((file: IservFile, index) =>
                                        <View key={index} style={styles.fileContainer}>
                                            <Pressable android_ripple={{ color: colors.background }} onPress={() => Linking.openURL(file.url.toString())} style={styles.fileWrapper}>
